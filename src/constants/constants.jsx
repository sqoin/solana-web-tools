...
export const NETWORK_ID_NOT_ACCESSIBLE =
  "Network not accessible please switch to either Rinkbey or Kovan";

// wallet links
export const SOLLET_LINK =
  "https://chrome.google.com/webstore/detail/sollet/fhmfendgdocmcbmfikdcogofphimnkno";
export const METAMASK_LINK = "https://metamask.io/download.html";

export const PHANTOM_LINK = "https://phantom.app/";