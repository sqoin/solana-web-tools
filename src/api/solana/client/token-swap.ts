...
export class TokenSwap {
  ...
  constructor(
    ...
    mintA: PublicKey,
    mintB: PublicKey,
    tradeFeeNumerator: any,
    tradeFeeDenominator: any,
    ownerTradeFeeNumerator: any,
    ownerTradeFeeDenominator: any,
    ownerWithdrawFeeNumerator: any,
    ownerWithdrawFeeDenominator: any,
    hostFeeNumerator: any,
    hostFeeDenominator: any,
    curveType: number,
    payer: Account,
  ) {
    Object.assign(this, {
  ...
  async swap(
    ...
    console.log("=========>connection", this.tokenSwap.toBase58(), this.swapProgramId.toBase58(),
      this.tokenProgramId.toBase58(), this.poolToken.toBase58(),
      this.feeAccount.toBase58(), this.authority.toBase58(),
      this.tokenAccountA.toBase58(),
      this.tokenAccountB.toBase58(),
      this.mintA.toBase58(),
      this.mintB.toBase58()
    )
  ...
  static swapInstruction(
    ...
    keys.forEach(
      (key, i) => {
        if (!key.pubkey.equals) {
          console.log(i + " => " + key.pubkey + " does not have a equal, na77i");
        }
      }
    )
